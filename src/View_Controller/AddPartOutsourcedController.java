...
public class AddPartOutsourcedController implements Initializable {
    ...
    private void inhouse(ActionEvent event) throws IOException {
        System.out.println("Opening Add Part inhouse Screen.");
        
        Parent addPartOutParent = FXMLLoader.load(getClass().getResource("AddPartInHouse.fxml"));
    ...
    private void saveButtonClicked(ActionEvent event) throws IOException {
        ...
        if (partName.getText() == null || partName.getText().trim().isEmpty()){
            ...
            alert.showAndWait();
        } else if (partCompanyName.getText() == null || partCompanyName.getText().trim().isEmpty()){
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Empty Field Error");
            ...
            String companyName = String.valueOf(partCompanyName.getText());
            ...
            parts.add( new OutsourcedPart(id, name, price, instock, max, min, companyName));   
    ...
    void initialize() {
        assert save != null : "fx:id=\"save\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert cancel != null : "fx:id=\"cancel\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert addPartInHouse != null : "fx:id=\"addPartInHouse\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert addPartToggleGroup != null : "fx:id=\"addPartToggleGroup\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert addPartOutsourced != null : "fx:id=\"addPartOutsourced\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partID != null : "fx:id=\"partID\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partName != null : "fx:id=\"partName\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert priceCost != null : "fx:id=\"priceCost\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partMax != null : "fx:id=\"partMax\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partCompanyName != null : "fx:id=\"companyName\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partMin != null : "fx:id=\"partMin\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
        assert partInventory != null : "fx:id=\"partInventory\" was not injected: check your FXML file 'AddPartOutsourced.fxml'.";
    }
}
